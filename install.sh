#!/usr/bin/env bash
# =============================================================================
# cc-epub v2.0 - 一键安装脚本 (Kindle 适配版)
...
echo "============================================"
echo "  cc-epub v2.0 安装程序 (Kindle 适配版)"
...
echo ""
echo "Kindle 适配说明："
echo "  脚本已内置 Kindle 防 PDF 化清洗（步骤8），"
echo "  自动移除 position:absolute/fixed、float、display:flex 等"
echo "  会导致 Kindle 强制转 PDF 的 CSS 属性。"
